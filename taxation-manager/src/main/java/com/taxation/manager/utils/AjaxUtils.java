...
public class AjaxUtils {
    ...
    public static String ajaxJsonRetcodeMessage(HttpServletResponse response,String retCode,Object data, String message) {
        Map<String, String> jsonMap = new HashMap<String, String>();
        jsonMap.put(MESSAGE, message);
        jsonMap.put(RETURN_CODE, retCode);
        jsonMap.put(DATA, JSONObject.fromObject(data).toString());
        JSONObject jsonObject = JSONObject.fromObject(jsonMap);
        return ajax(response, jsonObject.toString(), "text/html");
    }
    /**
